...
namespace Assignment_02_EF.Migrations
{
    /// <inheritdoc />
    public partial class FinalFullSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Department_Data", x => x.Dept_ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Instructors_Department_Data_Dept_ID",
                        column: x => x.Dept_ID,
                        principalTable: "Department_Data",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Student_Info_Department_Data_Dep_Id",
                        column: x => x.Dep_Id,
                        principalTable: "Department_Data",
                        principalColumn: "Dept_ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stud_Courses_Student_Info_Stud_ID",
                        column: x => x.Stud_ID,
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Department_Data_Instructors_Ins_ID",
                table: "Department_Data",
                column: "Ins_ID",
                principalTable: "Instructors",
                principalColumn: "ID",
